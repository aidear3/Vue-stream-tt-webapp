<template>
    <div class="d-container" style="margin-top: 120px;" @click="navigationStateChange()">
        <iframe id="siberPlayer" name="siberPlayer" style="height: calc(87vh);width: 100vw;" :src="iframeSrc"
...
export default {
    ...
    data() {
        return {
            ...
            SVODs: [],
            isDev: devMode,
            iframeSrc: "https://https://player.streamtnt.com/player.php?match=" + this.$route.params.sportId + "&about=1&matches=1"
        }
    },
    mounted() {
